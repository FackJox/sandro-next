  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className='fixed z-30 flex-col items-center w-screen h-screen bg-transparent text-icewhite'
        id='1'
      >
        <div id='2' className=' flex h-96 w-full'></div>
        <div id='3' className='grid grid-cols-3 grid-rows-3 gap-2 w-screen h-1/4 '>
          <Link href='/portfolio/motion'>
            <div className='col-start-3 row-start-3 lg:row-start-2 h-32 w-full flex justify-center items-center '>
              ...
              <motion.p layoutId='motion' className='h-12 w-full text-3xl lg:text-5xl text-center text-icewhite'>
                MOTION
              </motion.p>
            </div>
          </Link>
          ...
          <Link href='/about'>
            <div className='col-start-2 row-start-2 h-36 w-full flex justify-center items-center'>
              <p className=' h-16 text-5xl lg:text-7xl text-center text-gold justify-self-center'>ABOUT</p>
            </div>
          </Link>

          <Link href='/portfolio/stills'>
            <div className='col-start-1 row-start-3 lg:row-start-2 h-32 w-full flex justify-center items-center'>
              ...
              <motion.p layoutId='stills' className='w-full h-12 text-3xl lg:text-5xl text-center text-icewhite'>
                STILLS
              </motion.p>
            </div>
          </Link>
