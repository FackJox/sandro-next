    ...
    >
      ...
      >
        ...
        <div className='flex items-center col-span-2 col-start-2 row-start-5 pl-40'>
          <p className='w-[530px] h-[108px] text-2xl text-left text-white font-Poppins'>
        ...
        <div className='flex items-end justify-end col-span-2 col-start-1 row-start-3 pr-40 '>
          <p className='items-end justify-end flex w-[530px] h-[108px] text-2xl text-left text-white font-Poppins'>
        ...
        <div className='col-start-1 row-span-3 row-start-4 pl-24'>
          <img src='/img/about/portrait.jpg' className='w-[200px] h-[246px] rounded-[536px] object-cover' />
        </div>
      </motion.div>
    </div>
  )
